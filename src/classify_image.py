    ...
    def __init__(self,
        ...
        if not label_lookup_path:
            label_lookup_path = os.path.join(
                FLAGS.dataset, 'imagenet_2012_challenge_label_map_proto.pbtxt')
        if not uid_lookup_path:
            uid_lookup_path = os.path.join(
                FLAGS.dataset, 'imagenet_synset_to_human_label_map.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_file', type=str, default='../dataset/imagenet/cropped_panda.jpg')
